    ...
    return (
        <div className="relative inline-block text-left" ref={dropdownRef}>
            <button
             ...
             hover:ring-2 hover:ring-green-400 transition
            ...
            {open && (
                <div className="absolute right-0 mt-2 w-48 bg-green-50 border border-gray-200 rounded-lg shadow-lg z-50 overflow-hidden">
                    <Link
                        href={`/user/dashboard`}
