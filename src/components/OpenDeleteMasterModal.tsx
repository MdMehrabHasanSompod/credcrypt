    ...
    return (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 px-4 animate-in fade-in zoom-in duration-200">
            ...
            <div className="w-full max-w-md bg-white rounded-2xl shadow-2xl overflow-hidden">
                ...
                <div className="bg-linear-to-r from-red-700 to-red-600 px-6 py-4 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-red-100">
                                Enter your master key to delete
                            </p>
                        </div>
                    </div>
                    <button
                    ...
                    <div className="flex items-center gap-3 p-4 bg-red-50 rounded-xl border border-red-200 mb-6">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-red-600">
                                Enter your master key to delete this credential
                            </p>
                        </div>
                    </div>
