        ...
        ${showMobileSearch ? "opacity-100" : "opacity-0 md:opacity-100"}`}
            ...
            >
                ...
                <input
                    ...
                    className="w-full pl-10 pr-6 py-3 border text-xs md:text-sm border-gray-300 rounded-full focus:outline-none focus:ring-2 focus:ring-green-500 bg-green-50"
                />
