...
const Homepage = () => {
    ...
    const features = [
        ...
        },
        {
            ...
            description: "Share credentials securely with team members without compromising security.",
            ...
            <div className="min-h-screen bg-linear-to-b from-green-50 via-white to-green-50/30 pt-24 md:pt-28 lg:pt-32">
                ...
                <footer className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 border-t border-gray-200">
                    <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                        <div className="flex items-center gap-2">
                            <div onClick={() => scrollTo(0, 0)} className='relative w-10 h-10 bg-green-500 rounded-full'>
                                <Image
                                    src="/logo.png"
                                    alt="CredCrypt"
                                    fill
